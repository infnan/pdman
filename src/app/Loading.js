...
export default class Loading extends React.Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => {
      if (fileExist(this.historyPath)) {
        readFilePromise(this.historyPath)
          .then((res) => {
            this.setState({
  ...
  render() {
    if (this.state.width !== '100%') {
      ...
      return (
        <div className='pdman-loading-content'>
          <div className='pdman-loading-content-img'>
            <div style={{ textAlign: 'center', marginTop: 100 }}>
              ...
              <div className='pdman-loading-content-welcom'>
                <span style={{ fontSize: 35, fontWeight: 2, color: '#65B1F0' }}>
                  WELCOME
                </span>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <span style={{ fontSize: 35, fontWeight: 2, color: '#FFF' }}>
                  PDMAN
                </span>
              </div>
            </div>
            <div style={{ position: 'relative', width: '100%', height: '30%' }}>
              ...
              <div className='pdman-loading-content-progress'>
                <div className='pdman-loading-content-progress-base'>
                  <div
                    className='pdman-loading-content-progress-base-line'
            ...
            <div className='pdman-loading-content-footer'>
              <div className='pdman-loading-content-footer-content'>
                Copyright© {version.date.split('.')[0]} robergroup team All
                rights reserved
              </div>
            </div>
          </div>
