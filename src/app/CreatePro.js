...
export default class CreatePro extends React.Component {
  ...
  render() {
    ...
    return (
      <div className='pdman-create' style={style}>
        <div className='pdman-create-left'>
          ...
          <div className='pdman-create-left-back'>
            <Icon
              ...
              style={{ color: '#3AAEDC' }}
              onClick={this._closeCreatePro}
            />
          </div>
        </div>
        <div className='pdman-create-right'>
          <div className='pdman-create-right-title'>新项目</div>
          <div className='pdman-create-right-com'>
            <div className='pdman-create-right-com-label'>路径:</div>
