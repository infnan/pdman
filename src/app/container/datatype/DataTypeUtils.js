          ...
          flag &&
            ...
            callBack({
              ...
              dataTypeDomains: {
                ...
                datatype: _object
                  .get(dataSource, 'dataTypeDomains.datatype', [])
                  .concat(tempDataType),
              },
            });
        }
  ...
  if (dataTypeCode) {
    tempDataSource = {
      ...
      dataTypeDomains: {
        ...
        datatype: _object
          .get(tempDataSource, 'dataTypeDomains.datatype', [])
...
export const copyDataType = (dataTypeCode, dataSource) => {
  ...
  if (dataTypeCode) {
    ...
    clipboard.writeText(
      JSON.stringify(_object.get(dataSource, 'dataTypeDomains.datatype', [])),
    );
  }
};
...
export const pasteDataType = (dataSource, callBack) => {
  ...
  if (
    Array.isArray(data) &&
    data.every(dataType => validateDataType(dataType))
  ) {
    ...
    callBack &&
      callBack({
        ...
        dataTypeDomains: {
          ...(dataSource.dataTypeDomains || {}),
          datatype: hasExistData.concat(
            data.map((dataType) => {
              const code = validateDataTypeCodeAndName(
                hasExistDataCode.concat(copyDataTypeDataCode),
                dataType.code,
              );
              const name = validateDataTypeCodeAndName(
                hasExistDataName.concat(copyDataTypeDataName),
                dataType.name,
              );
