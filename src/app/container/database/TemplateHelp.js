      ...
      <div>
        <div className={`${prefix}-database-template-help-content-tab`}>
          {data.map(db => (
            <div
              ...
              className={`${prefix}-database-template-help-content-tab-${
                selected === db.code ? 'selected' : 'unselected'
              }`}
            >
              {db.code.toLocaleUpperCase()}
            </div>
          ))}
        </div>
        <div
        ...
        >
          ...
          <div
            ...
            className={`${prefix}-data-table-content-tab${
              this.state.templateShow === 'rebuildTableTemplate'
                ? '-selected'
                : '-unselected'
            }`}
          >
          ...
          <div
            ...
            className={`${prefix}-data-table-content-tab${
              this.state.templateShow === 'createFieldTemplate'
                ? '-selected'
                : '-unselected'
            }`}
          >
          ...
          <div
            ...
            className={`${prefix}-data-table-content-tab${
              this.state.templateShow === 'updateFieldTemplate'
                ? '-selected'
                : '-unselected'
            }`}
          >
          ...
          <div
            ...
            className={`${prefix}-data-table-content-tab${
              this.state.templateShow === 'deleteFieldTemplate'
                ? '-selected'
                : '-unselected'
            }`}
          >
          ...
          <div
            ...
            className={`${prefix}-data-table-content-tab${
              this.state.templateShow === 'deleteIndexTemplate'
                ? '-selected'
                : '-unselected'
            }`}
          >
          ...
          <div
            ...
            className={`${prefix}-data-table-content-tab${
              this.state.templateShow === 'createIndexTemplate'
                ? '-selected'
                : '-unselected'
            }`}
          >
          ...
          <div
            ...
            className={`${prefix}-data-table-content-tab${
              this.state.templateShow === 'updateTableComment'
                ? '-selected'
                : '-unselected'
            }`}
          >
